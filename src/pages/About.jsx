        ...
        <main className="max-w-3xl mx-auto px-4 py-12">
            ...
            <section>
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                    ...
                    {/* <a href="www.linkedin.com/in/timnguyen-dev" target="_blank" rel="noreferrer" className="rounded-lg border border-[color:var(--border)] bg-[color:var(--surface)] px-3 py-1.5 text-sm hover:opacity-90">LinkedIn</a> */}
                </div>
            </section>
        </main>
    );
